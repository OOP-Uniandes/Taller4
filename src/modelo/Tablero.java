...
public class Tablero {
	...
	// ********************************
	/**
	 * Una matriz con las casillas del tablero: true significa que est� apagado
	 */
	...
	/**
	 * La cantidad de jugadas realizadas hasta el momento desde la �ltima vez que se
	 * reinici� el tablero.
	 */
	private int jugadas;
	...
	/**
	 * Crea un nuevo tablero del tama�o indicado. El tablero se crea con tamano x
	 ...
	 * aleatorias. Si antes de ejecutar este m�todo el tablero estaba todo
	 * iluminado, esto garantiza que se vaya a poder resolver despu�s.
	 * 
	 * El n�mero de jugadas realizadas se mantiene constante
	 * 
	 ...
	 * las iluminadas se apagan y viceversa. Incrementa en 1 el n�mero de jugadas
	...
	/**
	 * Informa si todas las casillas del tablero est�n iluminadas
	 * 
	 * @return
	 */
	 ...
	 * 
	 * @return Una cantidad de puntos que depende del tama�o del tablero y de la
